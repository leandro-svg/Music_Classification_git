...
from netst.LoadNett import load_model
...
def main():
    ...
    config_path = "C:\\Users\\leand\\Repos\\Music_Classification\\configs\\config.json"
    ...
    net_params['in_dim'] = dataset.nbr_feature
    net_params['n_classes'] = dataset.nbr_classes
    net_params['size'] = dataset.size
